...
public class AddFamilyTree extends AppCompatActivity implements Validator.ValidationListener {
                ...
                if (MainServices.isConnectedToVanshavaliServer()) {
                    ...
                    try {
                        ...
                        if (jsonobj.getInt("code") == 200) {
                            showToasty("success", AddFamilyTree.this, jsonobj.getString("message"), Toasty.LENGTH_LONG);
                            Intent i = new Intent(AddFamilyTree.this,FamilyList.class);
                            startActivity(i);
                            finish();
                        } else {
                            showToasty("error", AddFamilyTree.this, jsonobj.getString("message"), Toasty.LENGTH_LONG);
                        }
                    } catch (IOException e) {
                        Log.e("Io Exception ", e.getMessage());
                        showToasty("success", AddFamilyTree.this, e.getMessage(), Toasty.LENGTH_LONG);
                    } catch (JSONException e) {
                        Log.e("Io Exception ", e.getMessage());
                        showToasty("error", AddFamilyTree.this, e.getMessage(), Toasty.LENGTH_LONG);
                    }


                } else {
                    //server connection error
                    showToasty("error",AddFamilyTree.this,"Server Connection Error",Toasty.LENGTH_LONG);
                }
            }
        };
        connthread.start();
    ...
    public void Logout() {
        ...
        edit.clear();
        edit.apply();
        Intent i = new Intent(AddFamilyTree.this, LoginActivity.class);
